...
Public Class A_Form
    ...
    Private Sub B_Load_Inputs_Click(sender As Object, e As EventArgs) Handles B_Load_Inputs.Click
        Dim sw As StreamReader = New StreamReader("C:\Users\Lenovo\Documents\GitHub\Projects-University-\Greenhouse Energy Calculator\greenhouse_calculator\_Energy\settings.inf", FileMode.Open)
